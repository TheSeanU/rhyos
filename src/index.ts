...
import type { ViteSvgIconsPlugin, FileStats, DomInject } from './types'
import {
  SVG_DOM_ID,
  SVG_ICONS_CLIENT,
...
const debug = Debug.debug('vite-svg-icons')

export function svgIcons(opt: ViteSvgIconsPlugin): Plugin {
